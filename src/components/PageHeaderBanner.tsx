...
export const PageHeaderBanner: React.FC<PageHeaderBannerProps> = ({
  ...
  return (
    <div className="relative pt-32 sm:pt-34 md:pt-36 pb-3 sm:pb-3.5 bg-gradient-to-r from-[#243348] via-[#2F415A] to-[#243348] text-white overflow-hidden border-b-2 border-orange-500/30 shadow-md">
